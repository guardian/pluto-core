...
class ProjectEntryView extends GenericEntryView {
  ...
  render() {
    return (
      <span>
        <UserEntryView username={this.state.content.user} />{" "}
        <ProjectTypeView entryId={this.state.content.projectTypeId} /> project
        &quot;{this.state.content.title}&quot; from{" "}
        {moment(this.state.content.created).format("ddd Do MMM, HH:mm")}
      </span>
    );
  }
}
