...
class ProjectTemplateDeleteComponent extends GeneralDeleteComponent {
  ...
  getSummary() {
    return (
      <SummaryComponent
        fileId={this.state.selectedItem.fileRef}
    ...
    if (this.state.warning)
      ...
      return (
        <p className="information">
          The following {this.itemClass} will be PERMANENTLY deleted, along with
          the file on-disk, if you click the Delete button below. Do you want to
          continue?
        </p>
      );
  }
