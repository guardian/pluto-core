...
class NameComponent extends CommonMultistepComponent {
  ...
  projectNameChanged(event) {
    const newFileName = this.state.autoNameFile
      ? this.makeAutoFilename(event.target.value)
      : this.state.fileName;
    this.setState(
      {
            ...
            <tr>
              ...
              <td>
                <input
                  ...
                  disabled={this.state.autoNameFile}
                />
              </td>
              <td>
                <input
                  id="autoNameCheck"
                  type="checkbox"
                  checked={this.state.autoNameFile}
                  onChange={(event) =>
                    this.setState({ autoNameFile: event.target.checked })
                  }
                />
