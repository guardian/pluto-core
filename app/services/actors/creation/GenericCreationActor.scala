...
trait GenericCreationActor extends Actor {
  val persistenceId:String  //for compatibility
...
//      updateState(event)
  ...
  override def receive: Receive = {
    case msg:Any=>
      logger.error(s"Received unknown message: ${msg.getClass.getCanonicalName} ${msg}")
  }
