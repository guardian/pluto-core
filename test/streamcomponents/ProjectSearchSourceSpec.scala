...
class ProjectSearchSourceSpec extends Specification with BuildMyApp {
  "ProjectSearchSource" should {
    "yield matching results from the database" in new WithApplication(buildApp) {
      ...
      result.head mustEqual ProjectEntry(Some(1),1,None,"InitialTestProject",Timestamp.valueOf("2016-12-11 12:21:11.021"),
        Option(Timestamp.valueOf("2016-12-11 12:21:11.021")),"me",None,None,None,None,None, EntryStatus.InProduction,
        ProductionOffice.UK)
    }
  }
}
